...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			所属年级:
			<select id="search-grade-id" class="easyui-combobox" style="width: 180px">
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8">
	    		<tr>
	    			<td>班级名:</td>
	    			<td>
	    				<input id="add_name"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="name" data-options="required:true, validType:'repeat', missingMessage:'请填写班级名'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>所属年级:</td>
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" border=0 cellpadding="8" >
	    		<tr>
	    			<td>班级名:</td>
	    			<td>
	    				<input id="edit_name"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="name" data-options="required:true, validType:'repeat', missingMessage:'请填写班级名'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>所属年级:</td>
