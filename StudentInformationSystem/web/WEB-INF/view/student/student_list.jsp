	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "确定要删除学生信息？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "delete",
...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			所属班级:
			<select id="search-clazz-id" class="easyui-combobox" style="width: 180px">
		 ...
		 <form id="photoForm" method="post" enctype="multipart/form-data" action="upload_Photo" target="photo_target">
	    	<table id="addTable1" cellpadding="8">
	    		<tr>
	    			<td>预览头像:</td>
	    			<td>
	    				<img id="photo-preview" alt="照片" style="max-width: 100px; max-height: 100px;" title="照片" src="/StudentInformationSystem_war_exploded/photo/student.jpg" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>学生头像:</td>
   		...
   		<form id="addForm" method="post">
	    	...
	    	<input id="add_photo"  type="hidden" name="photo" value="/StudentManager/photo/student.jpg" />
	    		<tr>
	    			<td>学生姓名:</td>
	    			<td>
	    		...
	    		<tr>
	    			<td>备注:</td>
	    			<td><textarea id="add_remark" style="width: 200px; height: 150px;" class="easyui-textbox" name="remark" data-options="multiline:true"/></textarea></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
	    ...
	    <form id="editPhotoForm" method="post" enctype="multipart/form-data" action="upload_Photo" target="photo_target">
	    	<table id="editTable1" cellpadding="8">
	    		<tr>
	    			<td>预览头像:</td>
	    			<td>
	    				<img id="edit-photo-preview" alt="照片" style="max-width: 100px; max-height: 100px;" title="照片" src="/StudentManager/photo/student.jpg" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>学生头像:</td>
   		...
   		<form id="editForm" method="post">
	    	...
	    	<input id="edit_photo"  type="hidden" name="photo" value="/StudentManager/photo/student.jpg" />
	    		<tr>
	    			<td>学生姓名:</td>
	    			<td>
	    		...
	    		<tr>
	    			<td>登录密码:</td>
	    			<td>
	    				<input id="edit_password"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="password" data-options="required:true,  missingMessage:'请填写登录密码'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>所属班级:</td>
	    		...
	    		<tr>
	    			<td>性别:</td>
	    			<td>
	    				<select id="edit_sex"  class="easyui-combobox" style="width: 200px;" name="sex" data-options="required:true, missingMessage:'请选择性别'">
	    						<option value="男">男</option>
	    						<option value="女">女</option>
	    				</select>
	    			</td>
	    		...
	    		<tr>
	    			<td>备注:</td>
	    			<td><textarea id="edit_remark" style="width: 200px; height: 150px;" class="easyui-textbox" name="remark" data-options="multiline:true"/></textarea></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
